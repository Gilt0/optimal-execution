...
$\min_{q_0, \dots, q_{N - 1}, N} \mathcal C\left(q_0, \dots, q_{N - 1}, N\right) = Qm_0 - Q \bar s - \left( q_nm_n + \int_{0}^{q_n} F^{-1}\left(\chi\right)d\chi \right) - \dots - \left( q_{N - 1}m_{N - 1} + \int_{0}^{q_{N - 1}} F^{-1}\left(\chi\right)d\chi \right)$
